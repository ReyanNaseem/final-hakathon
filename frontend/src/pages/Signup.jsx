    ...
    <div className="min-h-screen flex font-poppins bg-[#EDF4F2]">
      ...
      <div className="lg:w-1/2 w-full bg-[#EDF4F2] flex items-center justify-center p-10">
        <div className="w-full max-w-md">
          <h2 className="text-3xl text-green-600 lg:text-start text-center font-bold mb-8">Create Account</h2>
          ...
          {/* <div className="flex gap-4">
            <button className="flex-1 flex items-center justify-center gap-2 border border-[#31473A] py-2 rounded-md hover:bg-blue-50">
              ...
              <span className="text-sm text-green-600">Sign up with Google</span>
            </button>
          </div> */}

          {/* <div className="flex items-center justify-between my-6">
            <hr className="w-1/3 border-green-600" />
            <span className="text-sm text-green-600">or Sign In with</span>
            <hr className="w-1/3 border-green-600" />
          </div> */}
